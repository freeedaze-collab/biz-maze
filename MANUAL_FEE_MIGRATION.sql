-- ==========================================
-- FEE TRACKING MIGRATION - SAFE VERSION
-- ==========================================
-- Instructions:
-- 1. Copy this ENTIRE file
-- 2. Open Supabase Studio → SQL Editor
-- 3. Paste and click "Run"
-- 4. Run verification query at the end
-- ==========================================
...
-- ==========================================
-- VERIFICATION - Run this immediately after
-- ==========================================
-- This should return 3 rows if migration succeeded
SELECT column_name, data_type 
FROM information_schema.columns
WHERE table_name = 'all_transactions' 
  AND column_name IN ('parent_id', 'parent_type', 'row_type');

-- This should NOT ERROR (will show distribution of main vs fee)
