...
SELECT
    ...
    t.user_id,
    t.id::text as reference_id, -- <<< FIX: Was `t.tx_hash`, causing the `bigint` error.
    t.timestamp as date,
...
-- =================================================================
-- VIEW 2: v_all_transactions_classified (No changes from original)
-- =================================================================
...
-- =================================================================
-- VIEW 3: v_holdings (No changes from original)
-- =================================================================
