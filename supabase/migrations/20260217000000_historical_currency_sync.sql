-- Migration: Historical Currency Sync
-- This migration updates all_transactions to use historical exchange rates for all currencies.
...
-- 2. Recreate all_transactions with historical conversion
...
-- 3. Restore dependent views (Copied from previous restoration for safety)
