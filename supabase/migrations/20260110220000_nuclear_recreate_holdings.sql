-- Forcefully drop and recreate v_holdings.
-- Adds TRIM and UPPER to join condition for maximum matching robustness.
...
-- FIX: Robust Case-Insensitive JOIN with TRIM
JOIN
