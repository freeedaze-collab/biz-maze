...
export default function Dashboard() {
  ...
  const onSignOut = async () => { await supabase.auth.signOut(); nav("/", { replace: true }); };
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* --- Money/Send money/Create invoice → 一時非表示（戻しやすいようコメントアウト） --- */}
        {/*
        ...
        */}
        ...
        <div className="border rounded-xl p-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link to="/pricing" className="px-3 py-2 rounded border text-center">Pricing / Change plan</Link>
          </div>
        </div>
        ...
        <div className="border rounded-xl p-4">
          ...
          <p className="text-sm text-muted-foreground mb-2">Manage connected wallets and verification.</p>
        ...
        <div className="border rounded-xl p-4">
          ...
          <p className="text-sm text-muted-foreground mb-2">Configure merchant settings and generate checkout links.</p>
