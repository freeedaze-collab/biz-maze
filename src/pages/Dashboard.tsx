      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="border rounded-xl p-4">
          ...
          <div className="flex flex-col gap-2">
            <Link to="/send-money" className="px-3 py-2 rounded bg-blue-600 text-white text-center">Send money</Link>
            <Link to="/create-invoice" className="px-3 py-2 rounded border text-center">Create invoice</Link>
          </div>
        </div>
        */}
        ...
        <div className="border rounded-xl p-4">
          ...
          <p className="text-sm text-muted-foreground mb-2">
            Link Binance / Bybit / OKX to fetch history & balances.
          </p>
          <Link
            to="/vce"
            className="px-3 py-2 rounded border text-center inline-block"
