    ...
    <div className="max-w-2xl mx-auto p-4 space-y-4">
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          onChange={(e) => setProfile((prev: Profile | null) => prev ? { ...prev, account_type: e.target.value as Profile['account_type'] } : prev)}
        >
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) => setProfile((prev: Profile | null) => prev ? { ...prev, entity_type: e.target.value } : prev)}
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) => setProfile((prev: Profile | null) => prev ? { ...prev, tax_country: e.target.value } : prev)}
        />
      </div>
